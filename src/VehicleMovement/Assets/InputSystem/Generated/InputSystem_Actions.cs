...
//     version 1.19.0
//     from Assets/InputSystem/SimulationInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputSystem/SimulationInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @SimulationInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@SimulationInput()
    {
        UnityEngine.Debug.Assert(!m_Control.enabled, "This will cause a leak and performance issues, SimulationInput.Control.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, SimulationInput.UI.Disable() has not been called.");
    }
    ...
    {
        private @SimulationInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ControlActions(@SimulationInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@SimulationInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
